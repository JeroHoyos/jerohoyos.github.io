...
.kicker-series{{font-family:'DM Serif Display',serif;font-style:italic;font-size:1.3rem;color:var(--ink);letter-spacing:0}}
.kicker-sep{{color:var(--faint);font-size:.65rem;line-height:1}}
.kicker-ch{{font-size:.46rem;letter-spacing:3px;text-transform:uppercase;color:#f4f4ef;background:var(--ink);padding:.32rem .82rem}}
