...
.chip{font-size:.6rem;letter-spacing:1.5px;text-transform:uppercase;padding:.45rem 1.05rem;border:1px solid;border-radius:999px;transition:background .2s,transform .15s;cursor:default}
